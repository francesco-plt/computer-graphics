...
void createSpring(int nSlices, float steps, float r, float spireDist, int nRounds, float roundsDist)
{
    ...
    and with the vertex of the same slice of the next step.
    The second set of triangles is generated by connecting the vertex of
    the same slice of the next step with the vertex of the next slice
    of the next step, and with the vertex of the next slice of the
    current step.
    */
