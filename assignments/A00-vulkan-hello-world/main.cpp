...
// };
const std::vector<Model> SceneToLoad = {
	{"TEXT.gltf", GLTF, "rustediron-streaks-alb.png", "rustediron-streaks-norm_hei.png", "rustediron-streaks-met_rou_ao.png", {0, 1.0, 0}, 0.5},
	{"Primitives.gltf", GLTF, "redbricks2b-alb.png", "redbricks2b-norm_hei.png", "redbricks2b-met_rou_ao.png", {0, 0.5, -4.0}, 0.5},
...
private:
	...
	{
		auto app = reinterpret_cast<Assignment0 *>(glfwGetWindowUserPointer(window));
